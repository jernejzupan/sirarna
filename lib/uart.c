...
/*************************************************************************
Function: uart_isTxBusy()
Purpose:  Check if there are bytes in TxBuffer.
Warning: ATMEGA324P specific
Input:    None
Returns:  Intiger 0 or 1
**************************************************************************/
int uart_isTxBusy(void){
	if( (UART_TxHead == UART_TxTail) && (UCSR0A&(1<<TXC0)) )return(0);
	else return(1);
}/* uart_isTxBusy*/

/*************************************************************************
Function: uart1_isTxBusy()
Purpose:  Check if there are bytes in TxBuffer.
Warning: ATMEGA324P specific
Input:    None
Returns:  Intiger 0 or 1
**************************************************************************/
int uart1_isTxBusy(void){
	if( (UART1_TxHead == UART1_TxTail) && (UCSR1A&(1<<TXC1)) )return(0);
	else return(1);
}/* uart1_isTxBusy*/
