...
{
    if (theByte & 1<<7) lcd_D7_port |= (1<<lcd_D7_bit); // write 1 to D7
	else lcd_D7_port &= ~(1<<lcd_D7_bit);				// else write 0

    if (theByte & 1<<6) lcd_D6_port |= (1<<lcd_D6_bit);	// write 1 to D7
	else lcd_D6_port &= ~(1<<lcd_D6_bit);   			// else write 0

    if (theByte & 1<<5) lcd_D5_port |= (1<<lcd_D5_bit);	// write 1 to D7
	else lcd_D5_port &= ~(1<<lcd_D5_bit);				// else write 0
	  
    if (theByte & 1<<4) lcd_D4_port |= (1<<lcd_D4_bit);	// write 1 to D7
	else lcd_D4_port &= ~(1<<lcd_D4_bit);				// else write 0
